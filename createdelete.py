...
def get_sql_path(filename):
    """
    Retorna o caminho completo do arquivo SQL no diretório atual.
    """
    # Caminho fixo e correto do seu arquivo
    filepath = r"C:\Users\rafak\OneDrive\Área de Trabalho\projeto_bc\Ecommerce.sql"
    return filepath
